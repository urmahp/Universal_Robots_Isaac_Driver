...
public:
  ...
  /*!
   * \brief Channel to publish the anwser from the dashbordserver and whether the command was a succes.
   */
...
private:
   ...
   * \param succes Representing if the command was a succes.
   */
  struct Response
  {
    std::string anwser;
   ...
   * It matches the anwser with the expected anwser, to see if the command was a succes.
   *
