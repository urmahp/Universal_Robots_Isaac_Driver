...
class ExternalControlTest(unittest.TestCase):
	...
	def wait_for_robot_program_running(self, state, timeout=10):
	...
	def test_external_control(self):
		...
		# The joint positions, when control is handed back to the driver
		joint_states = [1.023, -1.236, 1.277, 4.657, -1.516, 1.878]
