...
class ScaledTrajectoryTest(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        cls.app.publish("ur.subgraph", "interface", "set_speed_slider", speed_fraction_msg)
        cls.app.stop()
    ...
    def test_scaled_trajectory_joint_position(self):
        """Test robot movement joint position commands, with speed scaled."""
        ...
        speed_fraction_msg = create_ur_msg("SpeedSliderProto")
        speed_fraction_msg.proto.speedSliderValue = speed_fraction
        self.app.publish("ur.subgraph", "interface", "set_speed_slider", speed_fraction_msg)
    ...
    def test_scaled_trajectory_joint_speed(self):
        """Test robot movement joint speed commands, with speed scaled."""
